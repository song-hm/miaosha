...
public interface OrderDao {
    ...
    public MiaoshaOrder getMiaoshaOrderByUserIdOrderId(@Param("userId") long userId,@Param("goodsId") long goodsId);
    ...
    public OrderInfo getOrderId(@Param("orderId") long orderId);
